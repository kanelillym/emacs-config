...
Gemini is a lightweight alternative to WWW Hypertext, with its own protocol and clients.

Elpher is a browser for Gemini and Gopher protocol pages.
...
ox-gemini is an org to gemini publishing tool, similar to =org-publish= for HTML.
...
I'm not sure if I want to include a direct gemini editing mode if I'm going to be mostly publishing out of org. Just in case, I call it out here.
...
I'm not actually currently using ledger, and I'm considering removing this section. I looked at it initially as a replacement for [[http://youneedabudget.com][YNAB]], but the difficulty of implementing a single system on my own which can track what money I have, where it is, *and* what I plan to use it for put me off it. Not solving that problem has-so far-been worth the subscription price.
